...
class CheckoutStrukHutang extends StatefulWidget {
  final int userId; // Mengambil ID pengguna untuk transaksi terakhir
  const CheckoutStrukHutang({required this.userId, Key? key}) : super(key: key);

  @override
  _CheckoutStrukHutangState createState() => _CheckoutStrukHutangState();
}

class _CheckoutStrukHutangState extends State<CheckoutStrukHutang> {
